...
import controller.DescriptionBoxChangeEvent;
...
/**
  * EReditor
  * view.DescriptionBoxEditorPanel.java
...
public class DescriptionBoxEditorPanel extends JPanel implements KeyListener
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 3340451012585593104L;
	...
	private void init()
	{
		...
		lblTitle.setText(ER_Editor.getLOCALIZATION().getString("description_box_title"));
		add(lblTitle);
		...
		lblDescription.setText(ER_Editor.getLOCALIZATION().getString("description_box_description"));
		add(lblDescription);
